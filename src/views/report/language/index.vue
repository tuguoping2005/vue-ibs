<template>
  <div class="app-container">
    <div align="left" style="margin-bottom:10px;">
      <el-button type="success" @click="addLanguage">Add Language</el-button>
    </div>
    ...
    >
      ...
      <el-table-column align="center" label="Object ID" >
        <template slot-scope="{ row }">
...
export default {
  ...
  methods: {
    ...
    async fetchList() {
      ...
      const { data } = await getLanguageList(this.listQuery);
